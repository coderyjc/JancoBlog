...
<div class="main">
  ...
  <el-collapse accordion class="search-bar">
    <el-collapse-item>
      <template slot="title">
        <i class="header-icon el-icon-search" style="font-size:20px;margin-right: 5px;"></i>筛选文章
      </template>
      <el-form ref="form" label-width="80px">
        ...
        <el-form-item label="类型">
            <el-select v-model="query.article_type" filterable placeholder="选择或搜索">
                <el-option
  ...
  <el-table
    ...
    <el-table-column
      ...
      width="120">
      <template slot-scope="scope">
        <el-button type="text" size="small"><a href="http://localhost:8080" target="_blank">查看</a></el-button>
...
<script>
import { getArticleByUser, batchDeleteArticles } from '@/api/article'
